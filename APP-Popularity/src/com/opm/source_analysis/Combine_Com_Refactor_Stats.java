    ...
    private static void stats() throws Exception {
        ...
        for (int a = 0; a < FILES3.length; a++) {
            ...
            while (count < numbers) {
                ...
                String project = File_Details.setProjectName(path_cfile + FILES3[a], count, "A2");
                String first = File_Details.setProjectName(path_cfile + FILES3[a], count, "C2");
                String last = File_Details.setProjectName(path_cfile + FILES3[a], count, "D2");
                ...
                System.out.println(count + " \t " + project.split("\\|")[0]);
