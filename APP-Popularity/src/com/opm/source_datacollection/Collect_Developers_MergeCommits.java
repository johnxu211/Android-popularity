...
public class Collect_Developers_MergeCommits {
    ...
    private static void stats() throws Exception {
        ...
        String file_google0 = "googleplay_com_dev_cd.xlsx";
        ...
        for (int a = 0; a < files_google.length; a++) {
            ...
            while (count < numbers) {
                ...
                List<Double> commits = ReadExcelFile_1Column.readColumnAsNumeric(path_google + files_google[a], count, 3, 2);
                List<Double> unique = ReadExcelFile_1Column.readColumnAsNumeric(path_google + files_google[a], count, 4, 2);
                List<String> commits_ = ReadExcelFile_1Column.readColumnAsString(path_google + files_google[a], count, 6, 1);
                ...
                List<String> category = ReadExcelFile_1Column.readColumnAsString(path_google + files_google[a], count, 7, 1);

                List<List<String>> lists_all = new ArrayList<>();
                List<List<String>> lists_all2 = new ArrayList<>();
                ...
                List<String> lists_1 = lists_all2.get(0);
                ///String combined1 = "";
                ...
                for (int i1 = 0; i1 < lists_all2.size(); i1++) {
                    List<String> lists = lists_all2.get(i1);
                    String combined = "";
                    List<Double> percL_2 = new ArrayList<>();
                    List<Double> tot_list_2 = new ArrayList<>();
                    List<String> rList2 = new ArrayList<>();
                ...
                String file_name = files_google[a].replaceAll("googleplay_com_dev", "merged_com_merged_2");
