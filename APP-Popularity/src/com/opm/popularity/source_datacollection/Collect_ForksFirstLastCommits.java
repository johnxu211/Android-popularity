...
import com.opm.popularity.read_gitrepos.Read_Commits;
...
public class Collect_ForksFirstLastCommits {
    ...
    private static void stats() throws Exception {
        ...
        for (int i = 0; i < repos.size(); i++) {
            ...
            List<List<String>> allList_1 = ReadReposCommits.countALLCOM(project, Constants.cons.TODAY_DATE, Constants.getToken(), ct);
            ...
            Create_ExcelFile.createExcel2(DataSets, 0, path_new + file_name, repos.get(i).split("/")[0] + "_" + i);
        }
        ///Create excel here....
    }
}
