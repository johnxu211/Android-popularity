                ...
                for (int a = 0; a < projL.size(); a++) {
                    ...
                    try {
                        if (new File(path + txtname.get(forks.indexOf(projL.get(a)))).exists()) {
                            ...
                            Create_ExcelFile.createExcel2(allobj, 0, path_new + file_name, projL.get(a).split("/")[0] + "_" + a);
                        }
                        ...
                        if (projL.get(a).equals(project.get(b)) && !forks.get(b).equals(projL.get(a))) {
                            ...
                            try {
                                if (new File(path + txtname.get(b)).exists()) {
                                    ...
                                    Create_ExcelFile.createExcel2(allobj, 0, path_new + file_name, projL.get(a).split("/")[0] + "_" + a + "_" + forks.get(b).split("/")[0] + "_" + b);
