    ...
    private static void check() throws Exception {
        ...
        for (int a = 0; a < files.length; a++) {
            ...
            while (sheet_index < total_sheets) {
                ...
                Create_ExcelFile.createExcel(DataSet, 0, path_new + output_file_name, "atleast_6");
                Create_ExcelFile.createExcel(DataSet2, 0, path_new + output_file_name, "lessthan_6");
                sheet_index++;
            }
        }
    }
